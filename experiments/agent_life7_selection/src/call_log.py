...
Копия (не импорт) `agent_life3_block_live/src/call_log.py`, без изменений
-- при grid=reuse не вызывается для новых строк (см. PROTOCOL.md), но
остаётся на случай BLOCKED-fallback пересборки."""
