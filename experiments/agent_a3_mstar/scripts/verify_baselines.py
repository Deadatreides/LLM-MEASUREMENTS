...
Независимая копия гейта `agent_a2_assemble_budget/scripts/verify_baselines.py`
(не импорт — пакеты агентов изолированы друг от друга), тот же принцип, что
и во всём проекте: |Δr| > 1e-4 -> СТОП, эталоны не подгоняются.
"""
